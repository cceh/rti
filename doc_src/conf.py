...
# -*- coding: utf-8 -*-
#
# RTI documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'RTI.tex', 'RTI Documentation',
...
man_pages = [
    (master_doc, 'rti', 'RTI Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RTI', 'RTI Documentation',
     author, 'RTI', 'One line description of project.',
     'Miscellaneous'),
]
